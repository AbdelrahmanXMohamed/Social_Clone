...
#api
    ...
    path("api/postsOfUser/<int:id>/<int:no>",views.get_posts_for_certain_user_pagination,name="certain_user"),
    path("api/whoCurrentUser",views.who_current_user,name="who_current_user"),
    path("api/followUser/<int:id>",views.follow_user,name="follow_user"),
    path("api/userProfile/<int:id>",views.user_profile,name="user_profile")
